...
GO
CREATE NONCLUSTERED INDEX [IX_CRMLoad_Contact_ProcessLoad_Criteria_1] ON [dbo].[CRMLoad_Contact_ProcessLoad_Criteria] ([LoadType]) INCLUDE ([SSB_CRMSYSTEM_CONTACT_ID])
GO
